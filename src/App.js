...
import {AdminHome, Order, AdminProducts, Category, CreateNewCategory, CreateNewProduct,CreateProductItem, ProductItems, ProductItemView, OrderView} from './admin/pages/index'
const App = () => {
    return (
        <>
            <Router basename='/app'>
